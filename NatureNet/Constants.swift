...
let ICON_DESIGN_IDEA_STATUS_TESTING = UIImage(named: "icon - testing")
let ICON_DESIGN_IDEA_STATUS_DEVELOPING = UIImage(named: "icon - developing")
...
//
let COMMUNITY_LIST_INIT_COUNT = 5
let COMMUNITY_LIST_LOAD_MORE_COUNT = 5
//
let PROJECTS_LIST_INIT_COUNT = 3
let PROJECTS_LIST_LOAD_MORE_COUNT = 3
//
let DESIGN_IDEA_LIST_INIT_COUNT = 5
let DESIGN_IDEA_LIST_LOAD_MORE_COUNT = 5
//
...
let ADD_OBSV_IMAGE_OPTIONS_ERR_LIB_BTN_DISMISS = "Dismiss"
let ADD_OBSV_IMAGE_OPTIONS_ERR_LIB_BTN_SETTINGS = "Review Settings"
let ADD_OBSV_IMAGE_OPTIONS_SAVE_PHOTO_ASK_PERM_TITLE = "Save Photo"
let ADD_OBSV_IMAGE_OPTIONS_SAVE_PHOTO_ASK_PERM_MSG = "To save your photo we need your permission to access your photo library."
let ADD_OBSV_IMAGE_OPTIONS_SAVE_PHOTO_ASK_PERM_BTN_ALLOW = "OK"
let ADD_OBSV_IMAGE_OPTIONS_SAVE_PHOTO_ASK_PERM_BTN_NO = "Not Now"
let ADD_OBSV_IMAGE_OPTIONS_NOT_SUPPORTED_TITLE = "Not supported"
let ADD_OBSV_IMAGE_OPTIONS_NOT_SUPPORTED_MSG = "Your selection is not supported as a NatureNet observation."
